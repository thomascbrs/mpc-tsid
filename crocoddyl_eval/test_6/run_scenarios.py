...
V = [0.7 ,  0.0]
o_feet_ , o_feet_heur , gait_ , pred_trajectories, pred_forces , l_feet_  , logger = run_simu(V)

pathIn = "crocoddyl_eval/test_6/log_eval/"
...
np.save(pathIn +  "xref.npy" , logger.xref )
